        ...
        <div className="bg-white border-b border-gray-200 flex items-center px-6 py-3">
          ...
          <div className="ml-auto flex items-center space-x-4">
            ...
            <div className="w-8 h-8 rounded-full bg-gray-200 flex items-center justify-center">
              <User name="Jhon Doe" className="w-4 h-4 text-gray-600" />
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-12 gap-6">
              ...
              <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-100">
                <div className="flex items-start space-x-3">
                  <div className="w-10 h-10 rounded-full bg-convrt-purple/20 flex items-center justify-center">
                    <User
                      name="Jhon Doe"
                      className="w-5 h-5 text-convrt-purple"
                    />
                  </div>
                  <div>
                    <p className="text-sm text-gray-700">
                      Hey Roy, I found a post that&apos;s relevant to your ICO
                      with 65% match. What do you want me to do?
                    </p>
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                <div className="p-4">
                  <div className="flex items-center space-x-3 mb-3">
                    <div className="w-12 h-12 rounded-full bg-gray-200 overflow-hidden">
                      <Image
                        src="/lovable-uploads/0f228602-2449-495f-866b-df124fde272a.png"
                        alt="Profile"
                    ...
                    <div>
                      <div className="flex items-center">
                        ...
                        <div className="ml-2 text-xs text-white bg-green-600 px-1.5 py-0.5 rounded">
                          LinkedIn
                        </div>
                      </div>
                      <p className="text-xs text-gray-500">
                        Growth Lead at TechCorp • 2h ago
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="mb-4">
                    <p className="text-sm text-gray-700">
                      Just launched our new AI-powered analytics dashboard and
                      the initial feedback has been incredible! 🚀 We&apos;re
                      seeing a 47% improvement in user engagement and a 3x
                      increase in data processing speed. Would love to hear your
                      thoughts on the future of AI in analytics.
                    </p>
                  </div>
                  ...
                  <div className="mt-4 relative">
                    ...
                    <div className="text-sm text-gray-700 bg-gray-50 p-3 rounded-md border border-gray-200">
                      The integration of AI in analytics represents a
                      significant leap forward in how businesses process and
                      utilize data. Your 47% engagement improvement highlights
                      the value of intuitive, AI-driven interfaces that present
                      insights in more actionable ways. As AI continues to
                      evolve, we&apos;ll likely see more predictive analytics
                      capabilities that not only tell us what happened but guide
                      strategic decision-making in real-time. Exciting times
                      ahead for the analytics space!
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-convrt-purple/5 p-4">
                  ...
                  <div className="w-full bg-gray-200 rounded-full h-2">
                    <div
                      className="bg-convrt-purple h-2 rounded-full"
                      style={{ width: "75%" }}
                    ></div>
                  </div>
            ...
            <div className="col-span-4 space-y-4">
              ...
              <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-100">
                ...
                <div className="text-convrt-purple font-medium text-sm">
                  3 Interactions
                </div>
              </div>
              ...
              <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-100">
                ...
                <div className="text-right text-sm font-medium text-convrt-purple">
                  85%
                </div>
              </div>
              ...
              <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-100">
                ...
                <div className="flex items-center space-x-2">
                  <div className="w-2 h-2 bg-convrt-purple rounded-full"></div>
                  <span className="text-convrt-purple font-medium">
              ...
              <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-100">
                ...
                <div className="flex flex-wrap gap-2">
                  <span className="bg-convrt-purple/10 text-convrt-purple text-xs px-2 py-1 rounded-md">
                    AI Analytics
                  </span>
              ...
              <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-100">
                ...
                <div className="space-y-2">
                  ...
                  <button className="w-full border border-convrt-purple text-convrt-purple py-2 rounded-lg text-sm font-medium flex items-center justify-center">
                    <User name="Jhon Doe" className="w-4 h-4 mr-2" />
                    Give to Agent
                  </button>
                </div>
              </div>
