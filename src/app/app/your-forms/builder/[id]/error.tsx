...
export default function BuilderErrorPage({
  ...
  useEffect(() => {
    console.error("Error en constructor de formularios:", error);
  }, [error]);
      ...
      <div className="max-w-md w-full bg-white rounded-2xl shadow-2xl p-8 text-center space-y-6">
        ...
        <div className="space-y-3">
          ...
          <p className="text-gray-600 text-base">
            Lamentamos el inconveniente. No pudimos cargar el constructor de
            formularios. Nuestro equipo ha sido notificado y estamos trabajando
