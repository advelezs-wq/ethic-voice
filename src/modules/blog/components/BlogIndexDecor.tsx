...
export function BlogIndexDecor() {
  return (
    <MarketingSectionV2
      className="!border-t-0 !py-8 md:!py-10"
      surface
      guides={[25, 50, 75]}
    >
      <div className="mx-auto max-w-4xl">
        <div className="relative overflow-hidden rounded-3xl border border-emerald-700/25 bg-gradient-to-br from-[#06251f] via-[#05382f] to-[#052b24] p-6 shadow-[0_24px_70px_-28px_rgba(6,37,31,0.75)] md:p-7">
          <div
          ...
          <div className="relative z-10 grid gap-4 md:grid-cols-12 md:items-center">
            <div className="md:col-span-8">
              ...
              <p className="mt-2 max-w-xl text-sm leading-relaxed text-white/80">
                Artículos prácticos sobre canal de denuncias, cultura de
                integridad y operación segura de casos, con el mismo enfoque que
                nuestra plataforma.
              </p>
            </div>
            <div className="grid gap-3 sm:grid-cols-2 md:col-span-4">
              {[
                ...
                >
                  <i
                    className={`${item.icon} h-5 w-5 text-emerald-300`}
                    aria-hidden
                  />
                  <p className="mt-1.5 text-sm font-bold text-white">{item.t}</p>
