 ...
 *
 * Deliberately not wrapped in SectionReveal: as the top-of-page header, it's always
 * already in the viewport when it mounts, so the scroll-triggered whileInView fade
 * only produced a flash of a washed-out, low-opacity banner on every page load/navigation
 * instead of an actual reveal.
 */
